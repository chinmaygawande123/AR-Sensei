...
public class GyroCamera : MonoBehaviour
{
	...
	private void Update()
	{
			...
			if(ForwardMove == 1)
			{
				...
				transform.position = new Vector3(
					...
					Mathf.Clamp(transform.position.y, 1.97f, 99999f),
	...
	{
		this.transform.position = new Vector3(0,1.97f,-10);
	}
}